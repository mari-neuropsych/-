...
files = {
    ...
    "vmrk": "https://s3.amazonaws.com/openneuro.org/ds005815/sub-05/ses-1/eeg/sub-05_ses-1_task-rest1_eeg.vmrk?versionId=6ukKnhGCp78Erue528BsnY6OJpxRm43"
}
...
# -------------------------
# 3. Flexible 1000-neuron network
num_neurons = 1000
neurons_to_plot = 10
eta = 0.1
...
# -------------------------
# 4. Plot first 10 neurons separately
